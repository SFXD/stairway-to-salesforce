...
class TestValidateResourceConfigs:
    ...
    def test_validate_multiple_configs_identifies_correct_error(self):
        ...
        configs = [
            ...
            {
                "name": "contacts",
                "sobject": "Contact"  # Missing primary_key
            }
        ]
...
class TestBuildResource:
    ...
    @patch('dlt_salesforce_advanced.sources.salesforce_bulk2.resource_builder.get_salesforce_driver')
    ...
    @patch('dlt_salesforce_advanced.sources.salesforce_bulk2.resource_builder.dlt.sources.incremental')
    @patch('dlt_salesforce_advanced.sources.salesforce_bulk2.resource_builder.get_salesforce_driver')
