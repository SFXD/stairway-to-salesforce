...
from dlt_salesforce_advanced.sources.salesforce_bulk2.source import (
...
class TestSalesforceSourceCreation:
    ...
    @patch('dlt_salesforce_advanced.sources.salesforce_bulk2.source.validate_resource_configs')
