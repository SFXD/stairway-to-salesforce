...
from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.common import (
    get_bulk_client,
    process_results,
...
class TestProcessResults:
    ...
    def test_process_results_with_failures(self, failed_job_result, sample_failed_records_csv):
        ...
        with patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.common._save_rejected_records') as mock_save:
    ...
    def test_process_results_partial_success(self, partial_success_job_result, sample_failed_records_csv):
...
class TestSaveRejectedRecords:
    ...
    def test_save_rejected_records_success(self, sample_failed_records_csv, temp_dir):
        ...
        with patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.common.get_rejected_records_path') as mock_path:
