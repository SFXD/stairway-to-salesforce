...
class TestProcessResults:
    ...
    def test_process_results_with_failures(self, failed_job_result, sample_failed_records_csv):
        ...
        with patch('stairway_to_salesforce.destinations.salesforce_bulk2.operations.common._save_rejected_records') as mock_save:
...
class TestSaveRejectedRecords:
    ...
    def test_save_rejected_records_success(self, sample_failed_records_csv, temp_dir):
        ...
        with patch('stairway_to_salesforce.destinations.salesforce_bulk2.operations.common.get_rejected_records_path') as mock_path:
