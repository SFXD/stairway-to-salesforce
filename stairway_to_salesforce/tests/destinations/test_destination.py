...
class TestDestinationWorkflow:
    ...
    @patch('stairway_to_salesforce.destinations.salesforce_bulk2.destination.get_salesforce_key_resolver')
    @patch('stairway_to_salesforce.destinations.salesforce_bulk2.destination.get_salesforce_driver')
    @patch('stairway_to_salesforce.destinations.salesforce_bulk2.destination.SalesforceDestinationConfig')
    def test_destination_workflow_components(
        ...
        from stairway_to_salesforce.destinations.salesforce_bulk2.destination import salesforce_bulk2
...
class TestDataProcessorIntegration:
    ...
    def test_prepare_data_called_with_items(
        ...
        # Cleanup
        from stairway_to_salesforce.destinations.salesforce_bulk2.data_processor import cleanup_temp_file
...
class TestComponentFactories:
    ...
    @patch('stairway_to_salesforce.components.salesforce_key_resolver.resolver.SalesforceKeyResolver')
