...
from dlt_salesforce_advanced.destinations.salesforce_bulk2.destination_config import (
...
class TestDestinationWorkflow:
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.destination.get_salesforce_key_resolver')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.destination.get_salesforce_driver')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.destination.SalesforceDestinationConfig')
...
class TestDataProcessorIntegration:
    ...
    def test_prepare_data_called_with_items(
        ...
        from dlt_salesforce_advanced.destinations.salesforce_bulk2.data_processor import prepare_data
        ...
        # Cleanup
        from dlt_salesforce_advanced.destinations.salesforce_bulk2.data_processor import cleanup_temp_file
...
class TestJobExecutorIntegration:
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.job_executor.exec_insert')
    def test_execute_job_insert_operation(self, mock_insert, mock_security_token_credentials, temp_csv_file):
        """Test execute_job calls correct operation handler."""
        from dlt_salesforce_advanced.destinations.salesforce_bulk2.job_executor import execute_job
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.job_executor.exec_upsert')
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.job_executor.exec_delete')
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.job_executor.exec_replace')
...
class TestComponentFactories:
    ...
    @patch('dlt_salesforce_advanced.drivers.salesforce_driver.sfdriver.make_salesforce_driver')
    @patch('dlt.secrets')
    ...
    @patch('dlt_salesforce_advanced.components.salesforce_key_resolver.resolver.SalesforceKeyResolver')
