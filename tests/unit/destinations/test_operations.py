...
from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.insert import exec_insert
from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.upsert import exec_upsert
from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.delete import exec_delete
from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace import exec_replace


class TestExecInsert:
    """Tests for exec_insert() operation."""
    
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.insert.process_results')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.insert.get_bulk_client')
...
class TestExecUpsert:
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.upsert.process_results')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.upsert.get_bulk_client')
...
class TestExecDelete:
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.delete.process_results')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.delete.get_bulk_client')
...
class TestExecReplace:
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace.exec_insert')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace.exec_delete')
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace._query_all_ids')
    ...
    @patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace.get_bulk_client')
    def test_replace_query_all_ids(self, mock_get_client):
        """Test _query_all_ids helper function."""
        from dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace import _query_all_ids
    ...
    def test_replace_logs_warning(self, mock_query, mock_insert, temp_csv_file, capsys):
        ...
        with patch('dlt_salesforce_advanced.destinations.salesforce_bulk2.operations.replace.exec_delete'):
            exec_replace(
                sf_driver=Mock(),
                target_name="Account",
                file_path=temp_csv_file
