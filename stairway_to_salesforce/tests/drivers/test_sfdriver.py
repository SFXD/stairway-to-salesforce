...
class TestGetSalesforceDriver:
    ...
    def setup_method(self):
        ...
        from stairway_to_salesforce.drivers.salesforce_driver.sfdriver_cache_manager import clear_cache
        clear_cache()
    ...
    @patch('stairway_to_salesforce.drivers.salesforce_driver.sfdriver.with_config', side_effect=lambda f: f)
    @patch('stairway_to_salesforce.drivers.salesforce_driver.sfdriver.make_salesforce_driver')
    @patch('dlt.secrets')
